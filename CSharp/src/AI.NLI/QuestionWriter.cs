...
public sealed class QuestionWriter(IChatClient chat)
{
    private const string Instruction =
        ...
        "без технических имен полей, без буквы ё и без длинных тире. Не добавляй новых вопросов и не меняй смысл. Причины: " +
        "«противоречие»: назови оба значения и откуда они; " +
        "«нужно точнее»: процитируй сказанное и попроси точное значение; " +
        "«от этого зависит вывод»: скажи, какое значение взято сейчас, и что от него зависит результат. " +
        "Верни field и text для каждого.";
